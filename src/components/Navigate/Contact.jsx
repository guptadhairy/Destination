...
import ContactBackground from '../particles/ContactBackground'
...
const Contact = () => {
  ...
  return (
    <Box minH={'100vh'} color={'whiteAlpha.900'} >
        <ContactBackground />
        <Container maxW={'container.md'}>
        <Heading display={'flex'} alignItems={'center'} padding={8} margin={'auto'} justifyContent={'center'}> Let’s create Memories Together</Heading>
            <form onSubmit={submitHandler} style={{marginTop: '20px'}}>
                ...
                <Button bgColor={'blue.500'} width={'50%'} alignItems={"center"} justifyContent={'center'} display={'flex'} margin={'auto'} fontSize={'1.2rem'} marginTop={"20px"} p={8} type='submit'>SEND</Button>
            </form>
        </Container>
